...
final pageBuilderMap = <String, Future<Widget> Function(Map<String, dynamic>)>{
  ...
  'CompletedTasks': (data) async => NavBarPage(initialPage: 'CompletedTasks'),
  'EditProfile': (data) async => EditProfileWidget(
        displayName: await getDocumentParameter(
            data, 'displayName', UsersRecord.serializer),
        email:
            await getDocumentParameter(data, 'email', UsersRecord.serializer),
      ),
  ...
  'PlannedTasks': (data) async => PlannedTasksWidget(),
};
